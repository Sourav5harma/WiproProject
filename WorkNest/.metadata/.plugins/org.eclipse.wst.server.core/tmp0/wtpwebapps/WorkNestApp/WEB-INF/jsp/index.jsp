...
} /* Footer at bottom but not stretching content */
footer {
	background: #a88fd8;
	color: white;
	padding: 1rem;
...
<body>
	...
	<div class="container">
		<div class="card">
			<h2>Admin Portal</h2>
			<p>Manage tasks, monitor progress, and oversee your team
				efficiently.</p>
			<a href="<c:url value='/admin/login'/>" class="btn">Go to Admin
				Login</a>
		</div>
		<div class="card">
			<h2>User Portal</h2>
			<p>Track tasks, collaborate, and stay focused in a peaceful
				environment.</p>
			<a href="<c:url value='/user/login'/>" class="btn">Go to User
				Login</a>
		</div>
	</div>
	<!-- Footer -->
