                ...
                : 'bg-info'}">
								...
								<div class="mt-3">
									<form class="d-inline" method="post"
										action="<c:url value='/tasks/status/${t.taskId}'/>">
										<input type="hidden" name="status" value="IN_PROGRESS">
										<button class="btn btn-sm btn-outline-primary">Mark
											In Progress</button>
									</form>
									<form class="d-inline" method="post"
										action="<c:url value='/tasks/status/${t.taskId}'/>">
									...
									<a class="btn btn-sm btn-link"
										href="<c:url value='/tasks/view/${t.slug}'/>">Open</a>
								</div>
								<p class="mt-2 text-muted small">Start: ${t.startDate} |
									Due: ${t.dueDate}</p>
							</div>
						</div>
					</div>
