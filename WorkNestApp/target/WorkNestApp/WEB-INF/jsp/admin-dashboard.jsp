			...
			<div class="card shadow-sm mb-4">
				...
				<div class="card-body">
					...
					<c:forEach var="t" items="${delayedTasks}">
                        ...
                        <form action="<c:url value='/admin/reassignTask'/>" method="post" style="display:flex; gap:.5rem; align-items:center; margin: .5rem 0 1rem;">
                            <input type="hidden" name="taskId" value="${t.taskId}" />
                            <select name="newUserId" style="padding:.5rem; border-radius:.6rem; border:1px solid #ddd;">
